...
export function fetchTokenTotalSupply(tokenAddress: Address): BigInt {
  ...
  return totalSupplyValue//BigInt.fromI32(totalSupplyValue as BigInt)
}
...
export function createLiquiditySnapshot(position: LiquidityPosition, event: ethereum.Event): void {
  ...
  if (pair !== null) {
    ...
    if (token0 !== null && token1 !== null && token0.derivedETH !== null && token1.derivedETH !== null && bundle !== null) {
      ...
      snapshot.token0PriceUSD = token0.derivedETH === null ? BigDecimal.fromString("0") : token0.derivedETH.times(bundle.ethPrice)
      snapshot.token1PriceUSD = token1.derivedETH === null ? BigDecimal.fromString("0") : token1.derivedETH.times(bundle.ethPrice)
